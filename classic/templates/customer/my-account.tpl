...
{block name='page_content'}
  <div class="row">
    <div class="links">
      ...
      {if isset($customer) && $customer.id_default_group == 4}
        <a class="col-lg-4 col-md-6 col-sm-6 col-xs-12" id="fds-link" href="{$urls.pages.url}/content/7-fds">
        <span class="link-item">
          <i class="material-icons">&#xe2c4;</i>
          {l s='FDS' d='Shop.Theme.Customeraccount'}
        </span>
        </a>
      {/if}
